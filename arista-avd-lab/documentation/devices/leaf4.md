...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.10.15/24 | 172.20.10.1 |
...
| --------- | --------------- | ------------ | --------- |
| LEAF3_4 | Vlan4094 | 10.255.1.68 | Port-Channel8 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet2 | SERVER_leaf3-4-server1_PCI2 | *trunk | *11-12,21-22 | *4092 | *- | 2 |
| Ethernet3 | SERVER_leaf3-4-server2_PCI2 | *trunk | *11-12,21-22 | *4092 | *- | 3 |
| Ethernet8 | MLAG_leaf3_Ethernet8 | *trunk | *- | *- | *MLAG | 8 |
| Ethernet9 | MLAG_leaf3_Ethernet9 | *trunk | *- | *- | *MLAG | 8 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet10 | P2P_spine1_Ethernet6 | - | 10.255.255.13/31 | default | 1500 | False | - | - |
| Ethernet11 | P2P_spine2_Ethernet6 | - | 10.255.255.15/31 | default | 1500 | False | - | - |
...
!
interface Ethernet2
   description SERVER_leaf3-4-server1_PCI2
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description SERVER_leaf3-4-server2_PCI2
   no shutdown
...
| Port-Channel3 | SERVER_leaf3-4-server2_Bond1 | trunk | 11-12,21-22 | 4092 | - | - | - | 3 | - |
...
interface Port-Channel3
   description SERVER_leaf3-4-server2_Bond1
   no shutdown
   switchport trunk native vlan 4092
   switchport trunk allowed vlan 11-12,21-22
   switchport mode trunk
...
router bgp 65102
   ...
   neighbor 10.255.255.12 description spine1_Ethernet6
   neighbor 10.255.255.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.14 remote-as 65100
   neighbor 10.255.255.14 description spine2_Ethernet6
   ...
   vrf VRF11
      ...
      update wait-install
      neighbor 10.255.1.100 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.100 description leaf3_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
