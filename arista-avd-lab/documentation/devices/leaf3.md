...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.10.14/24 | 172.20.10.1 |
...
| --------- | --------------- | ------------ | --------- |
| LEAF3_4 | Vlan4094 | 10.255.1.69 | Port-Channel8 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet2 | SERVER_leaf3-4-server1_PCI1 | *trunk | *11-12,21-22 | *4092 | *- | 2 |
| Ethernet3 | SERVER_leaf3-4-server2_PCI1 | *trunk | *11-12,21-22 | *4092 | *- | 3 |
| Ethernet8 | MLAG_leaf4_Ethernet8 | *trunk | *- | *- | *MLAG | 8 |
| Ethernet9 | MLAG_leaf4_Ethernet9 | *trunk | *- | *- | *MLAG | 8 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet10 | P2P_spine1_Ethernet5 | - | 10.255.255.9/31 | default | 1500 | False | - | - |
| Ethernet11 | P2P_spine2_Ethernet5 | - | 10.255.255.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet2
   description SERVER_leaf3-4-server1_PCI1
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description SERVER_leaf3-4-server2_PCI1
   no shutdown
...
| Port-Channel8 | MLAG_leaf4_Port-Channel8 | trunk | - | - | MLAG | - | - | - | - |
...
router bgp 65102
   ...
   vrf VRF10
      ...
      update wait-install
      neighbor 10.255.1.101 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.101 description leaf4_Vlan3009
   ...
   vrf VRF11
      ...
      update wait-install
      neighbor 10.255.1.101 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.101 description leaf4_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
