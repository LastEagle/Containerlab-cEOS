...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.10.12/24 | 172.20.10.1 |
...
| --------- | --------------- | ------------ | --------- |
| LEAF1_2 | Vlan4094 | 10.255.1.65 | Port-Channel8 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet2 | SERVER_leaf1-2-server1_PCI1 | *trunk | *11-12,21-22 | *4092 | *- | 2 |
| Ethernet8 | MLAG_leaf2_Ethernet8 | *trunk | *- | *- | *MLAG | 8 |
| Ethernet9 | MLAG_leaf2_Ethernet9 | *trunk | *- | *- | *MLAG | 8 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet10 | P2P_spine1_Ethernet3 | - | 10.255.255.1/31 | default | 1500 | False | - | - |
| Ethernet11 | P2P_spine2_Ethernet3 | - | 10.255.255.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet2
   description SERVER_leaf1-2-server1_PCI1
   no shutdown
   channel-group 2 mode active
!
interface Ethernet8
   description MLAG_leaf2_Ethernet8
   no shutdown
   channel-group 8 mode active
!
interface Ethernet9
   description MLAG_leaf2_Ethernet9
   no shutdown
   channel-group 8 mode active
!
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel2 | SERVER_leaf1-2-server1_Bond1 | trunk | 11-12,21-22 | 4092 | - | - | - | 2 | - |
| Port-Channel8 | MLAG_leaf2_Port-Channel8 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel2
   description SERVER_leaf1-2-server1_Bond1
   no shutdown
...
interface Port-Channel8
   description MLAG_leaf2_Port-Channel8
   no shutdown
   switchport mode trunk
...
router bgp 65101
   ...
   vrf VRF10
      ...
      update wait-install
      neighbor 10.255.1.97 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.97 description leaf2_Vlan3009
   ...
   vrf VRF11
      ...
      update wait-install
      neighbor 10.255.1.97 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.97 description leaf2_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
